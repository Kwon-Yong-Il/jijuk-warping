    ...
    def update_magnifier(self, event):
        if self.tk_image:
            ...
            if crop_left < crop_right and crop_top < crop_bottom:
                ...
                crosshair_length = 50  # 조절하려는 크기로 변경
                # Draw horizontal line
                self.canvas.create_line(center_x - crosshair_length, center_y, center_x + crosshair_length, center_y, fill="blue", tags="magnifier", width=2)

                # Draw vertical line
                self.canvas.create_line(center_x, center_y - crosshair_length, center_x, center_y + crosshair_length, fill="blue", tags="magnifier", width=2)
