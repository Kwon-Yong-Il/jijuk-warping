...
class PixelExtractor:
    ...
    def update_magnifier(self, event):
        if self.tk_image:
            ...
            magnifier_x = max(0, min(x - magnified_size / 2, self.original_image.width - magnified_size))
            magnifier_y = max(0, min(y - magnified_size / 2, self.original_image.height - magnified_size))

            self.canvas.coords(self.magnifier_image, magnifier_x, magnifier_y)
            ...
            center_x = magnifier_x + magnified_size / 2
            center_y = magnifier_y + magnified_size / 2
