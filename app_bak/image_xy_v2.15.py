    ...
    def on_click(self, event):
        ...
        if self.click_count == 0:
            ...
            if len(self.click_coords) > 1:
                x3, _, _, y2 = self.click_coords[1]
                x4, y4 = x + alpha, y2 + beta
                self.click_coords.append((x3, y2, x4, y4))
                ...
                messagebox.showinfo("Error", "Please click the third point after the second.")
