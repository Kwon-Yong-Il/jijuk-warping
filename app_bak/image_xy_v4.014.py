...
class PixelExtractor:
    ...
    def update_magnifier(self, event):
        if self.tk_image:
            ...
            # Update magnifier position to follow the mouse cursor
            self.magnifier_canvas.place(x=event.x, y=event.y, anchor=tk.CENTER)

            self.magnifier_image = ImageTk.PhotoImage(magnified_region)
            self.magnifier_canvas.create_image(self.magnifier_size / 2, self.magnifier_size / 2, image=self.magnifier_image)
            ...
            self.canvas.create_line(center_x - 5, center_y, center_x + 5, center_y, fill="red", tags="magnifier")

            # Draw vertical line
            self.canvas.create_line(center_x, center_y - 5, center_x, center_y + 5, fill="red", tags="magnifier")
