            ...
            with open(dogak_list_file_path, "r") as file:
                ...
                for line in lines:
                    ...
                    if len(fields) >= 3:
                        ...
                        if os.path.splitext(image_filename)[15] == os.path.splitext(os.path.basename(target_filename))[0]:
                            user_x, user_y = x, y
