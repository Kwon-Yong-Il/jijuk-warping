...
class PixelExtractor:
    ...
    def save_to_excel(self, image_filename, positions):
        ...
        for i, pos in enumerate(positions, start=1):
            user_x1, user_y1, user_x2, user_y2 = pos
            self.sheet.append([image_filename, f"Point {i}", user_x1, user_y1, user_x2, user_y2, 1, 0, 0, 0, clicked_time])
    ...
    def on_click(self, event):
        ...
        if self.click_count == 0:
            ...
            self.click_coords.append((user_x + alpha, user_y + beta, x1, y1))
            self.click_count += 1
