...
class PixelExtractor:
    ...
    def on_click(self, event):
        ...
        if self.click_count == 0:
            ...
            user_x2, user_y2 = simpledialog.askfloat("X Coordinate", f"Enter X coordinate for point {self.click_count + 1}",
                                                     parent=self.image_frame), \
                               simpledialog.askfloat("Y Coordinate", f"Enter Y coordinate for point {self.click_count + 1}",
                                                     parent=self.image_frame)
            self.click_coords.append((user_x2 + alpha, user_y2 + beta, x, y))
            self.click_coords.append((user_x + alpha, user_y, x1, y1))
            ...
            try:
                with open(filepath, "w") as file:
                    ...
                    for coords_set in self.click_coords:
                        ...
                        coords_line = f"{x1},{y1},{x2},{y2},1,0,0,0\n"
