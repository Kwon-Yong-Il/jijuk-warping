...
class PixelExtractor:
    ...
    def save_to_excel(self, image_filename, positions):
        ...
        self.workbook.save("image.xlsx")
        self.save_coordinates_to_file()  # 추가된 라인
    ...
    def on_click(self, event):
        ...
        if self.click_count < 2:
            ...
            if self.current_image_index < len(self.image_list):
                ...
                self.save_to_excel(image_filename, [(self.click_coords[1][0] + alpha, self.click_coords[1][1] + beta, self.click_coords[1][2], self.click_coords[1][3])])
