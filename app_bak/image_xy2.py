...
class PixelExtractor:
    ...
    def load_images(self):
        ...
        # Get a sorted list of all jpg files in the selected folder
        self.image_list = sorted([file for file in os.listdir(self.image_folder_path) if file.lower().endswith(".jpg")])
