...
class PixelExtractor:
    ...
    def update_magnifier(self, event):
        if self.tk_image:
            ...
            magnifier_x = event.x - self.magnifier_size / 2
            magnifier_y = event.y - self.magnifier_size / 2
    ...
    def get_magnifier_position(self):
        ...
        scroll_x, scroll_y = self.canvas.xview(), self.canvas.yview()

        # Calculate the position to place the magnified image above the original image
        magnifier_x = (scroll_x[0] + scroll_x[1]) * self.original_image.width - self.magnifier_size / 2
        magnifier_y = (scroll_y[0] + scroll_y[1]) * self.original_image.height - self.magnifier_size / 2
