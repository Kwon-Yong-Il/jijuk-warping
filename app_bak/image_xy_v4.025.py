...
class PixelExtractor:
    ...
    def update_magnifier(self, event):
        if self.tk_image:
            ...
            magnified_size = 200  # Set the magnified image size
            ...
            crop_left = int(magnifier_x)
            crop_top = int(magnifier_y)
            crop_right = int(magnifier_x + magnified_size)
            crop_bottom = int(magnifier_y + magnified_size)
