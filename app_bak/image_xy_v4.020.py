...
class PixelExtractor:
    ...
    def update_magnifier(self, event):
        if self.tk_image:
            ...
            magnifier_x = max(0, min(x, self.original_image.width - 1))
            magnifier_y = max(0, min(y, self.original_image.height - 1))
            ...
            self.canvas.create_line(0, center_y, magnified_size, center_y, fill="red", tags="magnifier")

            # Draw vertical line
            self.canvas.create_line(center_x, 0, center_x, magnified_size, fill="red", tags="magnifier")
