...
class PixelExtractor:
    ...
    def on_click(self, event):
        ...
        if self.click_count == 0:
            ...
            x2, y2 = x, y
            self.click_coords.append((user_x + alpha, user_y + beta, x2, y2))
            self.click_count += 1
        elif self.click_count == 2:
            user_x, user_y, _, _ = self.click_coords[0]
            user_x2, user_y2, _, _ = self.click_coords[1]
            x3, y3 = x, y
            self.click_coords.append((user_x + alpha, user_y + beta, x3, y3))
            self.click_coords.append((user_x2 + alpha, user_y2 + beta, x2, y2))
            self.click_coords.append((user_x + alpha, user_y, x, y))
