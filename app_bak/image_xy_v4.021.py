...
class PixelExtractor:
    ...
    def update_magnifier(self, event):
        if self.tk_image:
            ...
            crop_left = int(max(x - magnified_size / 2, 0))
            crop_top = int(max(y - magnified_size / 2, 0))
            ...
            self.canvas.create_line(magnifier_x, center_y, magnifier_x + magnified_size, center_y, fill="red", tags="magnifier")

            # Draw vertical line
            self.canvas.create_line(center_x + magnifier_x, 0, center_x + magnifier_x, magnified_size, fill="red", tags="magnifier")
