...
class PixelExtractor:
    ...
    def get_magnifier_position(self):
        ...
        magnifier_x = x - magnified_size / 2
        magnifier_y = y - magnified_size / 2

        # Ensure the magnifier is within the bounds of the original image
        magnifier_x = max(0, min(magnifier_x, self.original_image.width - magnified_size))
        magnifier_y = max(0, min(magnifier_y, self.original_image.height - magnified_size))
