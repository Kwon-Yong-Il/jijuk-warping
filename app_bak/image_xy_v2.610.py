...
class PixelExtractor:
    ...
    def on_click(self, event):
        ...
        if self.click_count == 0:
            # 사용자에게 x, y 값 입력
            user_x1 = simpledialog.askfloat("X Coordinate", f"Enter X coordinate for point {self.click_count + 1}", parent=self.image_frame)
            user_y1 = simpledialog.askfloat("Y Coordinate", f"Enter Y coordinate for point {self.click_count + 1}", parent=self.image_frame)
            pixelx1, pixely1 = x, y
