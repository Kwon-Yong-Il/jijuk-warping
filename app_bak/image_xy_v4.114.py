...
class PixelExtractor:
    ...
    def update_magnifier(self, event):
        if self.tk_image:
            ...
            self.canvas.create_line(center_x - crosshair_length, center_y, center_x + crosshair_length, center_y, fill="red", tags="magnifier")

            # Draw vertical line
            self.canvas.create_line(center_x, center_y - crosshair_length, center_x, center_y + crosshair_length, fill="red", tags="magnifier")
