...
class PixelExtractor:
    ...
    def load_images(self):
        ...
        self.load_image()
        self.load_target_dogak_coordinates(self.image_list[self.current_image_index], dogak_list_file_path)
    ...
    def on_click(self, event):
        ...
        if self.click_count == 0:
            user_x, user_y = self.load_target_dogak_coordinates(self.image_list[self.current_image_index], self.dogak_list_file_path)
            pixelx1, pixely1 = x, y
